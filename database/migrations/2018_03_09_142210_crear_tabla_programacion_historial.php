...
class CrearTablaProgramacionHistorial extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('programacion_historial', function (Blueprint $table) {
    ...
    {
        Schema::drop('programacion_historial');
    }
}
