...
class DictamenTecnicoController extends Controller
{
    public function index(Request $request)
    {
        ...
        $registro = DictamenTecnico::with("areaOperativa", "tipoDocumento", "giro");
    ...
    public function show($id)
    {
        try{
            DB::beginTransaction();
            $registro = DictamenTecnico::find($id);
            DB::commit();
            return Response::json([ 'data' => $registro ],200);
    ...
    public function store(Request $request)
    {
        ...
        $reglas = [
            ...
            "id_dictaminador"=> 'required', 
            "fecha_recepcion"=> 'required',
            "id_giro"=> 'required',
            "establecimiento"=> 'required',
            "id_tipo_dictamen"=> 'required',
            "fecha_dictamen"=> 'required',
            "id_resultado_lesp"=> 'required',
            "id_anomalias"=> 'required',
            "id_medida_seguridad"=> 'required',
            "no_notificacion"=> 'required',
            "fecha_emision"=> 'required',
            "fecha_entrega_notificar"=> 'required',
            "fecha_notificacion"=> 'required',
            "id_respuesta_usuario"=> 'required',
            "acta_seguimiento_numero"=> 'required',
            "id_estatus"=> 'required',
            "fecha_envio_resolucion"=> 'required',
        ];
        ...
        */
        ...
        try{
            DB::beginTransaction();
            $registro = DictamenTecnico::create($parametros);
            DB::commit();
            return Response::json([ 'data' => $registro ],200);
