...
use App\Models\ResolucionAdministrativa;
...
class ResolucionAdministrativaController extends Controller
{
    public function index(Request $request)
    {
        ...
        $registro = ResolucionAdministrativa::with("areaOperativa", "giro", "estatus");
    ...
    public function show($id)
    {
        try{
            DB::beginTransaction();
            $registro = ResolucionAdministrativa::find($id);
            DB::commit();
            return Response::json([ 'data' => $registro ],200);
    ...
    public function store(Request $request)
    {
        ...
        $reglas = [
            ...
            "id_resolutor"=> 'required', 
            "no_expediente"=> 'required',
            "fecha_recepcion"=> 'required',
            "id_giro"=> 'required',
            "establecimiento"=> 'required',
            "id_procedencia"=> 'required',
            "no_citatorio"=> 'required',
            "fecha_notificacion_citatorio"=> 'required',
            "fecha_comparecencia"=> 'required',
            "no_resolucion"=> 'required',
            "fecha_emision"=> 'required',
            "id_sancion"=> 'required',
            "fecha_notificacion_resolucion"=> 'required',
            "id_estatus"=> 'required',
            "id_recurso_inconformidad"=> 'required',
            "fecha_envio_juridico"=> 'required',
        ...
        */
        ...
        try{
            DB::beginTransaction();
            $registro = ResolucionAdministrativa::create($parametros);
            DB::commit();
            return Response::json([ 'data' => $registro ],200);
