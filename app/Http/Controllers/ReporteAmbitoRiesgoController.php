...
use App\Models\ProgramacionTema, App\Models\Usuario, App\Models\Muestra, App\Models\Verificacion;
use App\Models\Capacitacion, App\Models\Dictamen, App\Models\Reaccion, App\Models\Determinacion, App\Models\AmbitoRiesgo, App\Models\DictamenArchivo, App\Models\TipoSeguimiento;
...
class ReporteAmbitoRiesgoController extends Controller
{
    public function index(Request $request)
    {
        ...
        $tema = AmbitoRiesgo::find($parametros['ambito']);
        ...
        $datos = ProgramacionTema::join("tema", "tema.id", "=", "programacion_jurisdiccion.id_tema")
                                   ...
                                   ->get();
        $datos_archivo = DictamenArchivo::whereRaw("id_dictamen in (select id from dictamen where id_tema in (select id from tema where id_ambito_riesgo='".$parametros['ambito']."' and deleted_at is null) and anio='".date("Y")."' and deleted_at is null)")
