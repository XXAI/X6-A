...
Route::resource('promocion_tema', 'PromocionTemaController',    ['only' => ['index', 'show', 'store','update','destroy']]);
Route::resource('tema', 'TemaController',    ['only' => ['index', 'show', 'store','update','destroy']]);
Route::resource('tema-variable', 'TemaVariableController',    ['only' => ['index', 'show', 'store','update','destroy']]);
Route::resource('variable', 'variableController',    ['only' => ['index', 'show', 'store','update','destroy']]);
